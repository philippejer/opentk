...
namespace CustomOpenTK.Input
{
    ...
    public sealed class KeyboardDevice : IInputDevice
    {
        ...
        /// <summary>
        /// Retrieves the combined <see cref="CustomOpenTK.Input.KeyboardState"/> for all keyboard devices.
        /// This method is equivalent to <see cref="CustomOpenTK.Input.Keyboard.GetState()"/>.
        /// </summary>
        /// <returns>An <see cref="CustomOpenTK.Input.KeyboardState"/> structure containing the combined state for all keyboard devices.</returns>
        /// <seealso cref="CustomOpenTK.Input.Keyboard.GetState()"/>
        ...
        /// <summary>
        /// Retrieves the <see cref="CustomOpenTK.Input.KeyboardState"/> for the specified keyboard device.
        /// This method is equivalent to <see cref="CustomOpenTK.Input.Keyboard.GetState(int)"/>.
        /// </summary>
        /// <param name="index">The index of the keyboard device.</param>
        /// <returns>An <see cref="CustomOpenTK.Input.KeyboardState"/> structure containing the combined state for all keyboard devices.</returns>
        /// <seealso cref="CustomOpenTK.Input.Keyboard.GetState(int)"/>
