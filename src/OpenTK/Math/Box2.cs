...
namespace CustomOpenTK
{
    ...
    public struct Box2 : IEquatable<Box2>
    {
        ...
        /// </summary>
        /// <param name="topLeft">An CustomOpenTK.Vector2 describing the top-left corner of the Box2.</param>
        /// <param name="bottomRight">An CustomOpenTK.Vector2 describing the bottom-right corner of the Box2.</param>
        ...
        /// <param name="right">The position of the right boundary.</param>
        /// <param name="bottom">The position of the bottom boundary.</param>
        /// <returns>A new CustomOpenTK.Box2 with the specfied dimensions.</returns>
